...
namespace CS2AllCases.Lib.Models
{
    public class FractureCase : ICases
    {
        ...
        [
            Skins.SSG08Mainframe001,
            Skins.SG553OlRusty,
            Skins.PPBizonRunic,
            Skins.P90Freight,
            Skins.P250Cassette,
            Skins.P2000Gnarled,
            Skins.NegevUltralight
        ];
        ...
        [
            Skins.Tec9Brother,
            Skins.MP5SDKitbash,
            Skins.MAG7MonsterCall,
            Skins.MAC10Allure,
            Skins.GalilARConnexion
        ];

        private List<Skins> SkinsClassified =
        [
            Skins.XM1014Entombed,
            Skins.M4A4ToothFairy,
            Skins.Glock18Vogue
        ];

        private List<Skins> SkinsSecret =
        [
            Skins.DesertEaglePrintstream,
            Skins.AK47LegionOfAnubis
        ];
