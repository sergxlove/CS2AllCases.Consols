...
namespace CS2AllCases.Lib.Models
{
    public class Spectrum2Case : ICases
    {
        ...
        [
            Skins.Tec9CrackedOpal,
            Skins.SCAR20JungleSlipstream,
            Skins.SawedOffMorris,
            Skins.MAC10Oceanic,
            Skins.Glock18OffWorld,
            Skins.G3SG1Hunter,
            Skins.AUGTriqua
        ];
        ...
        [
            ...
            Skins.SG553Phantom,
            Skins.MP9Goo,
            Skins.CZ75AutoTacticat
        ];

        private List<Skins> SkinsClassified =
        [
            Skins.R8RevolverLlamaCannon,
            Skins.PPBizonHighRoller,
            Skins.M4A1SLeadedGlass
        ];

        private List<Skins> SkinsSecret =
        [
            Skins.P250SeeYaLater,
            Skins.AK47TheEmpress
        ];
